...
set CLASSPATH=%APP_HOME%\lib\test.jar;%APP_HOME%\lib\aes-everywhere-java-1.2.7-SNAPSHOT.jar


@rem Execute test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_OPTS%  -classpath "%CLASSPATH%" test.Main %*
